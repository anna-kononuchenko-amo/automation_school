...
public class СheckOneHundredMovies {

    @Test (dataProvider = "movie")
    public void movieDataTest (String title, String link, String rating, String year) {
        Selenide.open(link);
    ...
    public Iterator<Object[]> movie() {
        List<Object[]> list = getMovieInfo();
        return list.iterator();
    }

    public List<Object[]> getMovieInfo() {
